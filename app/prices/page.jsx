...
const Prices = () => {
  const priceData = [
  {
    section: "Укладки",
    items: [
      { name: "Дневная [браш]", price: 5500 },
      { name: "Коктейльная [горячий инструмент / бэки]", price: 6000 },
  ...
  },
  {
    ...
    items: [
      { name: "Lebel Абсолютное счастье волос (без укладки)", price: 9000 },
      // { name: "Nashi Argan Molecular Repair pro (без укладки)", price: 8000 },
      { name: "Nashi Argan Filler (без укладки)", price: 7000 },
      { name: "Nashi Argan Filler-экспресс (без укладки)", price: 4500 },
      { name: "Nashi Argan базовый (без укладки)", price: 4500 },
      { name: "TOKIO INKARAMI экспресс уход (без укладки)", price: 7500 },
      { name: "TOKIO INKARAMI spa-уход (без укладки)", price: 9500 },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Покрытие лак Hermes", price: 2500 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Сложное окрашивание до плеч (с укладкой)", price: 29500 },
      { name: "Сложное окрашивание ниже плеч (с укладкой)", price: 34500 },
      { name: "Окрашивание в один тон до плеч (без укладки)", price: 10500 },
      { name: "Окрашивание в один тон ниже плеч (без укладки)", price: 12000 },
      { name: "Окрашивание корней (без укладки)", price: 9000 },
      { name: "Осветление корней (без укладки)", price: 8500 },
      { name: "Тонирование до плеч (без укладки)", price: 10500 },
      { name: "Тонирование ниже плеч (без укладки)", price: 12000 },
      { name: "Частичное мелирование до 10 прядей (без укладки)", price: 8500 },
    ],
  },
  {
